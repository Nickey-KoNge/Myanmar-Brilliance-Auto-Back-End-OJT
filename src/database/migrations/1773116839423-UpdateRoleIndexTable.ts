...
export class UpdateRoleIndexTable1773116839423 implements MigrationInterface {
  name = 'UpdateRoleIndexTable1773116839423';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_068c1346f603dca1702fb893c0" ON "master_company"."refresh_tokens" ("refresh_token") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_ba3bd69c8ad1e799c0256e9e50" ON "master_company"."refresh_tokens" ("expires_at") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_36c7f5a6a8d1c7c23470457dc3" ON "master_company"."refresh_tokens" ("revoked") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_c5df785092839917858f5f6e44" ON "master_company"."refresh_tokens" ("refresh_token", "revoked") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_110b0c2a71e5f70805fa328b41" ON "master_company"."credentials" ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_8b70bfa2ca2987a0464ad40e96" ON "master_company"."credentials" ("email", "status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_43f11fec7a56a48dfbde40fa2e" ON "master_company"."staff" ("staff_name") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_4d4956f0d921cf205e2c34e130" ON "master_company"."staff" ("phone") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_7915a0ef1701c5ee56f716f559" ON "master_company"."staff" ("credential_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_4e4bf5357315e806b391188d3e" ON "master_company"."staff" ("company_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_08ca698771f9a1b8ed8f98e6d1" ON "master_company"."staff" ("branches_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_c3fe01125c99573751fe5e5566" ON "master_company"."staff" ("role_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_155a4dd6291492056cb01f174c" ON "master_company"."staff" ("gender") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_9d2b6bd3270a246dbfbb59bae9" ON "master_company"."staff" ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_7a20a3afc16adc4dff8a0812f9" ON "master_company"."staff" ("company_id", "status") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_402ae23575a228a1e6c6e95aaf" ON "master_company"."staff" ("branches_id", "status") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_ac35f51a0f17e3e1fe12112603" ON "master_service"."roles" ("role_name") `,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_14958a120176d4e1e8be423977" ON "master_service"."roles" ("status") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "master_service"."IDX_14958a120176d4e1e8be423977"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_service"."IDX_ac35f51a0f17e3e1fe12112603"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_402ae23575a228a1e6c6e95aaf"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_7a20a3afc16adc4dff8a0812f9"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_9d2b6bd3270a246dbfbb59bae9"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_155a4dd6291492056cb01f174c"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_c3fe01125c99573751fe5e5566"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_08ca698771f9a1b8ed8f98e6d1"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_4e4bf5357315e806b391188d3e"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_7915a0ef1701c5ee56f716f559"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_4d4956f0d921cf205e2c34e130"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_43f11fec7a56a48dfbde40fa2e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_8b70bfa2ca2987a0464ad40e96"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_110b0c2a71e5f70805fa328b41"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_c5df785092839917858f5f6e44"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_36c7f5a6a8d1c7c23470457dc3"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_ba3bd69c8ad1e799c0256e9e50"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_company"."IDX_068c1346f603dca1702fb893c0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "master_service"."roles" ALTER COLUMN "id" DROP DEFAULT`,
    );
